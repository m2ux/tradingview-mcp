...
export function registerHealthTools(server) {
  ...
  server.tool('tv_ui_state', 'Get current UI state: which panels are open, what buttons are visible/enabled/disabled. dialogs / blocking_dialog include the Pine publish/update wizard (title, step, mode, buttons, close_surface) and the Open my script picker — even when those surfaces lack role=dialog.', {}, async () => {

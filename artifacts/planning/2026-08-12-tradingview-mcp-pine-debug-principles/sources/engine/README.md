...
> Application sources for the RSIZoneDiv library-generic refactor. Plan:
> `../07-library-generic-refactor-plan.md`. Not MCP server code — do not merge to `main`.
...
`../data/rszonediv_sym_lo_ukoil_30m_baseline.json` — 27 LOW / 31 HIGH. Every step must
